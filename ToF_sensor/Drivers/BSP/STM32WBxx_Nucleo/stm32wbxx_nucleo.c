...
/** @defgroup STM32WBXX_NUCLEO STM32WBXX_NUCLEO
 * @{
 */

/** @defgroup STM32WBXX_NUCLEO_LOW_LEVEL STM32WBXX_NUCLEO LOW LEVEL
...
/** @defgroup STM32WBXX_NUCLEO_LOW_LEVEL_Private_Defines STM32WBXX_NUCLEO LOW LEVEL Private Defines
 * @{
 */

/** @defgroup STM32WBXX_NUCLEO_LOW_LEVEL_FunctionPrototypes STM32WBXX_NUCLEO LOW LEVEL Private Function Prototypes
 * @{
 */
...
/** @defgroup STM32WBXX_NUCLEO_LOW_LEVEL_Private_Variables STM32WBXX_NUCLEO LOW LEVEL Private Variables
 * @{
 */
...
/** @defgroup STM32WBXX_NUCLEO_LOW_LEVEL_Private_Functions STM32WBXX_NUCLEO LOW LEVEL Private Functions
 * @{
 */
...
{
  return (int32_t)__STM32WBXX_NUCLEO_BSP_VERSION;
}
