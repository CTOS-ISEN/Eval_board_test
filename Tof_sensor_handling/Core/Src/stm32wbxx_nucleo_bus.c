...
/** @defgroup STM32WBXX_NUCLEO_BUS STM32WBXX_NUCLEO BUS
  * @{
  */

/** @defgroup STM32WBXX_NUCLEO_BUS_Exported_Variables BUS Exported Variables
  * @{
  */
...
/** @defgroup STM32WBXX_NUCLEO_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup STM32WBXX_NUCLEO_BUS_Private_FunctionPrototypes  BUS Private Function
  * @{
  */
...
/** @defgroup STM32WBXX_NUCLEO_BUS_Exported_Functions STM32WBXX_NUCLEO_BUS Exported Functions
  * @{
  */
